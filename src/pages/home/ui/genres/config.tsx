...
export const genres = [
  ...
  {
    href: paths.catalog({ genre: GenresEnum.Horror }),
    icon: <Icon name="genres/knife" />,
    text: 'Ужасы',
  },
  {
  ...
  },
  {
    ...
    icon: <Icon name="genres/people" />,
    text: 'Семейные',
  },
  {
    href: paths.catalog({ genre: GenresEnum.Comedy }),
    icon: <Icon name="genres/happy" />,
    text: 'Комедии',
  },
  {
    href: paths.catalog({ genre: GenresEnum.Concert }),
    icon: <Icon name="genres/music" />,
    text: 'Концерты',
  },
  {
    href: paths.catalog({ genre: GenresEnum.War }),
    icon: <Icon name="genres/tank" />,
    text: 'Военные',
  },
];
